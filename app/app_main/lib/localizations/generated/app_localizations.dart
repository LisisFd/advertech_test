...
abstract class AppLocalizations {
  ...
  /// No description provided for @titleContactUs.
  ///
  /// In en, this message translates to:
  /// **'Contact Us'**
  ...
  /// No description provided for @titleSend.
  ///
  /// In en, this message translates to:
  /// **'Send'**
  String get titleSend;

  /// No description provided for @titleWait.
  ///
  /// In en, this message translates to:
  /// **'Please wait'**
  String get titleWait;
  ...
  /// No description provided for @errorIncorrectEmail.
  ///
  /// In en, this message translates to:
  /// **'Email is incorrect'**
